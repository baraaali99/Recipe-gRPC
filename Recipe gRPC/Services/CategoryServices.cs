...
namespace Recipe_gRPC.Services
{
    public class CategoryServices: CategoryService.CategoryServiceBase
    {
		...
		private readonly string _recipesFile = Path.Combine(Environment.CurrentDirectory, "Recipes.json");
		private readonly string _categoriesFile = Path.Combine(Environment.CurrentDirectory, "Categories.json");
